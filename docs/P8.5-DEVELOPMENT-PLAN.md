...
- **P5.1–P5.5 shipped** (filesystem, desktop, browser, automation, **ai.***)
- **P6 / P7 planned** — memory/context + Whisper Flow ([P6–P7 plan](./P8.5-P6-P7-IMPLEMENTATION-PLAN.md))
- **Remaining tracker:** [`P8.5-REMAINING.md`](./P8.5-REMAINING.md)

Target: 20–30 tools in P8.5; 100–150 over P9+.

---

### Phase 6 — Memory + Context Intelligence (after P5.5)

**Jarvis that remembers.** Full plan: [P8.5-P6-P7-IMPLEMENTATION-PLAN.md](./P8.5-P6-P7-IMPLEMENTATION-PLAN.md).

- `memory.*` (10) — preferences, recent context, active workspace, rank choices, learn corrections, workflows, goals, forget
- `context.*` (2) — `build_execution_context`, `resolve_user_intent`
- Reuses existing aliases + semantic memory — does **not** add OS filesystem tools
- Wire preferred IDE into `open_project`; sticky workspace into inherit `projectRoot`

**Exit demo:** “Work on jkf” → “run typecheck” with no path; “always use Cursor”; “open my last project”.

---

### Phase 7 — Communication Intelligence / Whisper Flow (after P6)

**Jarvis that understands speech.** Not OS automation.

- Dual hotkeys: **Ctrl+Space** Command · **Alt+Space** Dictation
- Revision buffer + correction understanding (“tomorrow… no no… day after tomorrow”)
- AI rewrite + P6 name/project vocabulary
- Typing via existing insert ladder (P5.2) — no second typing stack
- Streaming is stretch; utterance + buffer is v1 exit

**Exit demo:** Dictation correction → single final sentence in focused app; Command mode unchanged.

---

### After P7 — OS Control wave (hands)

Copy/move/compare folders, run as admin, app properties — **after** P6/P7 demos. Distinct from classic Ripple Phase 7 (native Win32/UIA, already largely complete).
...
────────────────────────────────────────
  ...
  Phase 5: Add tools forever
           P5.1 filesystem · P5.2 desktop · P5.3 browser
           P5.4 automation · P5.5 ai.* (next)
  Phase 6: Memory + Context Intelligence (Jarvis remembers)
           → docs/P8.5-P6-P7-IMPLEMENTATION-PLAN.md
  Phase 7: Whisper Flow Communication Intelligence
           Command vs Dictation · revision buffer · smart typing
  Then:    OS Control wave (hands) · polish
  Deferred P8.6+: Event Bus · Execution Graph · Plugin Discovery

P9
────────────────────────────────────────
  Full observe/replan agent · 50–100 more tools · autonomy
```
