...
export const PLANNER_TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: "Send keyboard chords or key sequences (^a, ^c, {ENTER}, etc.) — compat shim",
    category: "desktop",
    wave: 1,
    argsSchema: {
      keys: { type: "string" },
  ...
  },
  {
    ...
    description: "Read foreground window hwnd, title, and process name",
    category: "desktop",
    wave: 2,
    argsSchema: {},
  },
  ...
  },
  {
    ...
    description: "Message or compose on Instagram via extension adapter",
    category: "communication",
    wave: 1,
    argsSchema: {
      kind: { type: "string", required: true },
  ...
  },
  {
    ...
    description: "Patch a text file via find/replace",
    category: "filesystem",
    wave: 2,
    argsSchema: {
      path: { type: "string", required: true },
  ...
  },
  {
    ...
    description: "Run an allowlisted script",
    category: "automation",
    wave: 2,
    argsSchema: {
  ...
  },
  {
    ...
    description: "Resolve and open a project in the detected IDE",
    category: "automation",
    wave: 2,
    argsSchema: {
  ...
  },
  {
    ...
    description: "Search source code in a project",
    category: "automation",
    wave: 2,
    argsSchema: {
      query: { type: "string", required: true },
  ...
  },
  {
    ...
    description: "Run TypeScript compiler (tsc --noEmit) and report errors",
    category: "automation",
    wave: 2,
    argsSchema: {
      projectRoot: { type: "string", required: true },
  ...
  },
  {
    ...
    description:
      "Explain the focused Cursor/VS Code file in Ripple UI (read-only, no insert)",
    category: "ai",
    wave: 2,
    argsSchema: {
      style: { type: "string" },
  ...
  },
  {
    ...
    description: "Bundle foreground, clipboard, and optional screen context",
    category: "ai",
    wave: 2,
    argsSchema: {
  ...
  },
  {
    ...
    description: "Locate a visible UI label via OCR and estimate click point",
    category: "ai",
    wave: 2,
    argsSchema: {
      query: { type: "string", required: true },
  ...
  },
  {
    ...
    description: "Analyze a goal and suggest next steps (no side effects)",
    category: "ai",
    wave: 2,
    argsSchema: {
  ...
  },
  {
    ...
    description:
      "Draft an ExecutionPlan for a goal (never executes; caller re-enters validator)",
    category: "ai",
    wave: 2,
    argsSchema: {
      goal: { type: "string", required: true },
  ...
  },
  {
    ...
    description: "Remember spoken → canonical mapping",
    category: "memory",
    wave: 2,
    argsSchema: {
